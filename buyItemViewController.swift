...
class buyItemViewController: UIViewController, UITableViewDataSource,UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as! buyItemInfoViewController
    ...
    func getData(){
        ...
        self.ref.child("myOrder").child(uid!).queryOrderedByKey().observe(.value) { (snapshot) in
            self.item.removeAll()
